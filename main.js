...
function reveal(bill, guests, tipAmount, dinerBill, totalTip) {
  ...
  <li>The individual tip amount will therefore be: £${tipAmount}</li>
  <li>Each diner's bill plus tip is: £${dinerBill}</li>
  <li>The total tip to pay including tip is: £${totalTip}</li>
